    ...
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-[100px] lg:px-6">
            <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                <p class="font-bold text-xl text-gray-900 lg:text-2xl">Ekstrakulikuler</p>
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">SMK Negeri 1 Garut</h2>
            </div>
            <div class="grid gap-8 lg:gap-14 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                <div class="text-center text-gray-500 shadow-lg rounded-lg p-6 w-56">
                    <img class="mx-auto mb-6 w-40 h-36 rounded-lg" src="images/logo.png" alt="Bonnie Avatar">
